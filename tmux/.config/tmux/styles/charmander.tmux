...
set -g status-right "#[fg=colour232,bg=colour232,nobold,nounderscore,noitalics]#[fg=colour241,bg=colour232] #(whoami)@#H #[fg=colour232,bg=colour232,nobold,nounderscore,noitalics]#[fg=colour252,bg=colour232] %b %d #[fg=colour232,bg=colour232,nobold,nounderscore,noitalics]#[fg=colour208,bg=colour232] %l:%M %P "
...
setw -g window-status-current-format "#[fg=colour232,bg=colour234,nobold,nounderscore,noitalics]#[fg=colour208,bg=colour234,bold] #F#I #W #[fg=colour234,bg=colour232,nobold,nounderscore,noitalics]"
